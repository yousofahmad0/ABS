...
public class TNORController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        button_go.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if(!tf_resn.getText().trim().isEmpty()) {
                    if(isInt(tf_resn,tf_resn.getText())) {
                        String mess = DBUtilsAdmin.functTNOR(Integer.parseInt(tf_resn.getText()));
                        if(mess != null){
                    ...
                    System.out.println("Please fill Reservation field");
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setContentText("Please fill Reservation Number to execute!");
                    alert.show();
                }
            }
        });
