...
public class AIFController implements Initializable {
            ...
            public void handle(ActionEvent event) {
                if(!tf_flightn.getText().trim().isEmpty()){
                    if(isInt(tf_flightn,tf_flightn.getText())){
                        String mess = DBUtilsAdmin.functAIF(Integer.parseInt(tf_flightn.getText()));
                        if(mess != null){
                            label_absents.setText(mess);
                        } else {
                            label_absents.setText("Error");
                            label_absents.setTextFill(Paint.valueOf("RED"));
                        }
                    }else {
